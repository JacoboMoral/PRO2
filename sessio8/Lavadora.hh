...
/** @class Lavadora
    ...
    Dispone de dos estados posibles (inicializada / no inicializada); si está inicializada tiene un peso máximo y un color y admite depositar prendas de dicho color hasta alcanzar dicho peso máximo; si no está inicializada solo se puede inicializar
*/
class Lavadora
{
public:
